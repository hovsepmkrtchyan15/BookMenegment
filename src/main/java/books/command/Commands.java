...
public interface Commands {
    ...
    static void printAdminCommands() {
        ...
        System.out.println("please input " + PRINT_BOOKS_BY_PRICE_RANGE + " for print books by price_range");
    ...
    static void printUserCommands() {
        ...
        System.out.println("please input " + PRINT_ALL_BOOKS + " for print all books");
        System.out.println("please input " + PRINT_BOOKS_BY_AUTHOR_NAME + " for print books by author name");
        System.out.println("please input " + PRINT_BOOKS_BY_GENRE + " for print books by gander");
        System.out.println("please input " + PRINT_BOOKS_BY_PRICE_RANGE + " for print books by price_range");
        System.out.println("please input " + PRINT_ALL_AUTHOR + " for print all author");
    }
